...
AOpenDoorMask::AOpenDoorMask()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> CubeMesh(TEXT("/Script/Engine.StaticMesh'/Game/model/green_mask/green.green'"));
	if (CubeMesh.Succeeded())
	{
		UE_LOG(LogTemp, Warning, TEXT("成功加载绿色面具模型: %s"), *CubeMesh.Object->GetName());
		MeshComponent->SetStaticMesh(CubeMesh.Object);
	}
	else
	{
		UE_LOG(LogTemp, Error, TEXT("无法加载绿色面具模型"));
	}
